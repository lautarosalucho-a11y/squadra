      ...
      {SECTIONS.map((s) => {
        ...
        return (
          <section key={s.key} style={{ marginBottom: "var(--space-2)" }}>
            <button type="button" onClick={() => toggleSection(s.key)} style={{ all: "unset", cursor: "pointer", display: "flex", alignItems: "center", gap: "var(--space-2)", padding: "var(--space-2)", width: "100%", boxSizing: "border-box" }}>
